# Valldigna Extrem 2026 — Informe de preparación

_Última actualización: 13 sept 2026_

## 1. La carrera

| Dato                   | Valor                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------------- |
| Nombre                 | Valldigna Extrem 2026                                                                          |
| Fecha                  | 21 de noviembre de 2026                                                                        |
| Organiza               | Centre Excursionista de Tavernes de la Valldigna                                               |
| Tipo                   | Marcha senderista de montaña, no federada, no competitiva, semi-autosuficiencia, no señalizada |
| Distancia oficial      | 40 km (según reglamento, puede variar según GPS)                                               |
| D+ oficial             | 1.800 m (según reglamento, puede variar según GPS)                                             |
| Salida                 | 07:00h, Plaça de l'Ajuntament de Tavernes de la Valldigna (a oscuras, frontal obligatorio)     |
| Corte total            | 12 horas (19:00h)                                                                              |
| Autosuficiencia mínima | 500 ml de agua propios                                                                         |

### Puntos de control / avituallamiento (reglamento oficial)

| Km    | Lugar                                  | Horario de paso                     |
| ----- | -------------------------------------- | ----------------------------------- |
| 10    | Font del Barber                        | 08:30 - 10:00h                      |
| 19    | Simat de la Valldigna                  | 10:30 - 12:30h                      |
| 22    | Font del Cirer                         | 11:00 - 15:00h                      |
| 30    | Pla de Santoma                         | 14:00 - 18:00h                      |
| 38/40 | Ajuntament de Tavernes de la Valldigna | 15:30h hasta el último participante |

Ritmo medio permitido por el corte total: ~18 min/km incluyendo paradas — margen generoso dado el nivel de fondo del atleta (base de trekking). Objetivo realista: **8-9h**, con tramos corridos, sin ir al límite del corte.

## 2. Perfil real del recorrido (calculado desde GPX, track 2025)

El track de referencia mide ~36.8 km con D+1.658 m / D-1.652 m (ligera diferencia con el reglamento 2026, normal por GPS/variación de edición).

| Tramo (km) | Desnivel | Pendiente                | Descripción                                     |
| ---------- | -------- | ------------------------ | ----------------------------------------------- |
| 0-2        | +280 m   | 3.7% → 15.6% en km1      | Rampa inicial muy dura nada más salir           |
| 3-7        | +390 m   | 8-9.5% sostenido         | Subida principal 1, la más larga                |
| 8          | -197 m   | **-19.6%**               | Bajada muy técnica                              |
| 9-12       | -320 m   | -7% a -13%               | Bajada larga sostenida                          |
| 13-17      | ondulado | -2% a +1.3%              | Tramo llano/rodante, el más "runneable"         |
| 18-22      | +570 m   | 8-12%, **21.6% en km22** | Subida principal 2, la más dura de la carrera   |
| 23-24      | +200 m   | 4-6%                     | Continuación de subida, más suave               |
| 25-26      | -220 m   | **-14.5%**               | Bajada fuerte                                   |
| 27-33      | -290 m   | -1.3% a -5.8%            | Bajada/rodante largo, runneable con cuidado     |
| 34         | -189 m   | **-18.9%**               | Bajada muy técnica, la más dura del tramo final |
| 35-37      | -30 m    | suave                    | Llegada suave a meta                            |

**Zonas críticas para el atleta (historial de lesión de cuádriceps y rodillas propensas):** las 3 bajadas técnicas de km 8, 26 y 34 (-19.6%, -14.5%, -18.9%). El plan de fuerza excéntrico está diseñado específicamente para blindar estas zonas.

## 3. Perfil del atleta (resumen — ver `references/ATHLETE.md` para el detalle vivo)
...
## 4. Periodización — 10 semanas (13 sept → 21 nov 2026)

| Fase                    | Semanas | Objetivo                                                                                                 |
| ----------------------- | ------- | -------------------------------------------------------------------------------------------------------- |
| Base + prehab           | 1-3     | Reactivar volumen, introducir trabajo excéntrico y vertical en gym                                       |
| Construcción específica | 4-7     | Subir progresivamente la tirada larga (desnivel real), meter pendientes específicas del recorrido en gym |
| Pico                    | 8       | Día largo más exigente: simulacro completo (subida + rampa dura + bajada técnica + mochila + nutrición)  |
| Afinado                 | 9       | Bajar volumen, mantener algo de intensidad específica                                                    |
| Tapering                | 10      | Semana de carrera: -50% volumen, activación únicamente                                                   |
...
**Plan B para fin de semana sin salida posible:** sustituir la tirada larga por un "brick" de gym (stepmill/incline + step-downs excéntricos + bici/remo), ajustando el tiempo total a la duración objetivo de esa semana.

## 6. Rutinas

### 6.1 Fuerza 1 (Martes) — Pierna + excéntrico
...
| Prensa a una pierna                            | 3x12 por pierna | RPE 7                        |
| Glúteo medio (banda, clamshell o monster walk) | 3x15            | Activación previa o al final |
...
| 9 (sharpen) | Mantener carga, bajar volumen | 4 seg        | No acumular fatiga nueva                |
| 10 (taper)  | Mantenimiento ligero          | 3 seg        | Cero agujetas nuevas antes de carrera   |

Zancada búlgara y prensa unilateral siguen la misma progresión de carga (sube peso cada 2 semanas hasta semana 8, luego baja en 9-10).

### 6.2 Fuerza 2 (Miércoles) — Torso
...
### 6.4 Running 1 (Miércoles) — Cinta/stepmill vertical
...
| 9 (sharpen) | Mantener estructura, -20% volumen total                           | Igual que semana 6              | No acumular fatiga nueva                          |
| 10 (taper)  | 20 min suave, sin bloques duros                                   | 8-10%                           | Solo activación                                   |

Total de sesión: 30-45 min según fase.

### 6.5 Tirada larga de fin de semana
...
- Confirmar fines de semana disponibles para las tiradas largas y ajustar el calendario exacto.
- Definir material y estrategia de nutrición para el simulacro de la semana 8 y para el día de carrera.
- Actualizar este informe y `references/ATHLETE.md` a medida que haya datos nuevos del reloj o cambios de plan.
